...
export type NavBarJsonConnection = {
  totalCount: Scalars['Int'];
  edges: Array<NavBarJsonEdge>;
  nodes: Array<NavBarJson>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<NavBarJsonGroupConnection>;
};


export type NavBarJsonConnectionDistinctArgs = {
  field: NavBarJsonFieldsEnum;
};


export type NavBarJsonConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: NavBarJsonFieldsEnum;
};

export type NavBarJsonEdge = {
  next?: Maybe<NavBarJson>;
  node: NavBarJson;
  previous?: Maybe<NavBarJson>;
};

export type NavBarJsonFieldsEnum = 
  | 'id'
  | 'parent___id'
  | 'parent___parent___id'
  | 'parent___parent___parent___id'
...
export type NavBarJsonFilterInput = {
  ...
  seoTitle?: Maybe<StringQueryOperatorInput>;
  seoDescription?: Maybe<StringQueryOperatorInput>;
  tagCriteria?: Maybe<StringQueryOperatorInput>;
};

export type NavBarJsonFilterListInput = {
  elemMatch?: Maybe<NavBarJsonFilterInput>;
};

export type NavBarJsonGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<NavBarJsonEdge>;
  nodes: Array<NavBarJson>;
  pageInfo: PageInfo;
...
export type NavBarJsonSortInput = {
  fields?: Maybe<Array<Maybe<NavBarJsonFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type Query = {
  ...
  navBarJson?: Maybe<NavBarJson>;
  allNavBarJson: NavBarJsonConnection;
...
export type QueryNavBarJsonArgs = {
  id?: Maybe<StringQueryOperatorInput>;
  parent?: Maybe<NodeFilterInput>;
  children?: Maybe<NodeFilterListInput>;
  internal?: Maybe<InternalFilterInput>;
...
export type QueryAllNavBarJsonArgs = {
  filter?: Maybe<NavBarJsonFilterInput>;
  sort?: Maybe<NavBarJsonSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type SitePageContextArticleCreatedAtArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type SitePageContextArticleVideo = {
  youtubeUrl?: Maybe<Scalars['String']>;
  iframeTitle?: Maybe<Scalars['String']>;
};

export type SitePageContextArticleVideoFilterInput = {
  youtubeUrl?: Maybe<StringQueryOperatorInput>;
  iframeTitle?: Maybe<StringQueryOperatorInput>;
};

export type SitePageContextEntries = {
  html?: Maybe<Scalars['String']>;
  slug?: Maybe<Scalars['String']>;
  title?: Maybe<Scalars['String']>;
  audioUrl?: Maybe<Scalars['String']>;
...
export type SitePageContextEntriesCreatedAtArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type SitePageContextEntriesFilterListInput = {
  elemMatch?: Maybe<SitePageContextEntriesFilterInput>;
};
...
export type SitePageContextTabsFilterListInput = {
  elemMatch?: Maybe<SitePageContextTabsFilterInput>;
};
